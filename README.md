...
* 	Before you log a bug, please [search the issue tracker](https://github.com/AnanthaRajuC/List-of-programming-language-lists/search?type=Issues) to see if someone has already reported the problem.
* 	If the issue doesn't already exist, [create a new issue](https://github.com/AnanthaRajuC/List-of-programming-language-lists/issues/new)
...
2. Clone a copy of your fork on your local, replacing *YOUR-USERNAME* with your Github username.
   ...
   `git clone https://github.com/YOUR-USERNAME/List-of-programming-language-lists.git`
